namespace Oblivion.HabboHotel.Quests
{
    public class Quest
    {
        ...
        public Quest(int Id, string Category, int Number, QuestType GoalType, int GoalData, string Name, int Reward,
            string DataBit, int RewardType, int TimeUnlock, int TimeLock)
        {
            ...
            HasEnded = TimeLock >= OblivionServer.GetUnixTimestamp() && TimeLock > 0 ? true : false;
        }
