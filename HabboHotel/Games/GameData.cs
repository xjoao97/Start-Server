namespace Oblivion.HabboHotel.Games
{
    ...
    {
        public GameData(int GameId, string GameName, string ColourOne, string ColourTwo, string ResourcePath,
            string StringThree, string GameSWF, string GameAssets, string GameServerHost, string GameServerPort,
            string SocketPolicyPort, bool GameEnabled)
        {
            this.GameId = GameId;
