...
{
    internal class EnableUserEffectBox : IWiredItem
    {
        public EnableUserEffectBox(Room Instance, Item Item)
        {
        ...
        public WiredBoxType Type => WiredBoxType.EffectEnableUserEffect;
        ...
        public bool Execute(params object[] Params)
        {
            ...
            if (Player?.GetClient() == null || Effect < 0 || Effect == 102 || Effect == 178)
                return false;
