...
{
    class ToggleNegativeFurniBox : IWiredItem
    {
        ...
        {
            if (this._next == 0 || this._next < OblivionServer.Now())
                this._next = OblivionServer.Now() + this.Delay;
