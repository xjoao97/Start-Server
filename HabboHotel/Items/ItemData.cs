...
namespace Oblivion.HabboHotel.Items
{
    public class ItemData
    {
        ...
        public ItemData(int Id, int Sprite, string Name, string PublicName, string Type, int Width, int Length,
            double Height, bool Stackable, bool Walkable, bool IsSeat,
            bool AllowRecycle, bool AllowTrade, bool AllowMarketplaceSell, bool AllowGift, bool AllowInventoryStack,
            InteractionType InteractionType, int Modes,
            string VendingIds, string AdjustableHeights, int EffectId, int WiredId, bool IsRare, int ClothingId,
            bool ExtraRot, int behaviourData)
        {
            this.Id = Id;
            SpriteId = Sprite;
            ItemName = Name;
            ...
            if (VendingIds.Contains(",")) //todo: improve
