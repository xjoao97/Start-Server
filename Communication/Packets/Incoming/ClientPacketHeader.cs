namespace Oblivion.Communication.Packets.Incoming
{
    public static class ClientPacketHeader
    {
        ...
        public const int LoadJukeboxDiscsMessageEvent = 3847;
        public const int GetJukeboxPlaylistMessageEvent = 2304;
        public const int GetJukeboxDiscsDataMessageEvent = 341;
        public const int AddDiscToPlayListMessageEvent = 3138;
        public const int RemoveDiscFromPlayListMessageEvent = 2280;
        ...
        public const int UpdateForumReadMarkerMessageEvent = 3092;
        public const int UpdateForumThreadStatusMessageEvent = 3161;
        ...
        public const int ModerationMsgMessageEvent = 2767;
        ...
        public const int ModerationMuteMessageEvent = 3458; //3458
        ...
        public const int ChangeToSpectatorMode = 2596;
        public const int GetSanctionStatusMessageEvent = 3462; //b
        public const int HandleHelperToolMessageEvent = 2227;
        public const int AceptJoinJudgeChatMessageEvent = 2669;
        public const int CancelCallForHelperMessageEvent = 142;
        public const int CallForHelperMessageEvent = 321;
        public const int AcceptHelperSessionMessageEvent = 970;
        public const int HelperSessioChatTypingMessageEvent = 2535;
        public const int HelperSessioChatSendMessageMessageEvent = 2239;
        public const int CloseHelperChatSessionMessageEvent = 328;
        public const int VisitHelperUserSessionMessageEvent = 72;
        public const int InvinteHelperUserSessionMessageEvent = 2538;
        public const int FinishHelperSessionMessageEvent = 87;
        public const int ReportHelperSessionMessageEvent = 1788;
        ...
        public const int AcceptPollQuestiosMessageEvent = 455;
        public const int DeclinePollQuestionsMessageEvent = 165;
        public const int AnswerPollQuestionMessageEvent = 2815;
        public const int PurchaseTargetedOfferMessageEvent = 1408;
        public const int RoomNucsAlerta = 1223; // PRODUCTION-201607262204-86871104
        public const int CustomAction = 2114; // PRODUCTION-201607262204-86871104
        public const int FurniMaticPageEvent = 1403; // b
        public const int FurniMaticRecycleEvent = 1147; // b
        public const int FurniMaticRewardsEvent = 3052; //b
    }
}