...
using Oblivion.Communication.Packets.Incoming.Avatar;
using Oblivion.Communication.Packets.Incoming.Catalog;
using Oblivion.Communication.Packets.Incoming.GameCenter;
using Oblivion.Communication.Packets.Incoming.Groups;
using Oblivion.Communication.Packets.Incoming.Handshake;
using Oblivion.Communication.Packets.Incoming.Help;
using Oblivion.Communication.Packets.Incoming.Inventory.Achievements;
using Oblivion.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Oblivion.Communication.Packets.Incoming.Inventory.Badges;
using Oblivion.Communication.Packets.Incoming.Inventory.Bots;
using Oblivion.Communication.Packets.Incoming.Inventory.Furni;
using Oblivion.Communication.Packets.Incoming.Inventory.Pets;
using Oblivion.Communication.Packets.Incoming.Inventory.Purse;
using Oblivion.Communication.Packets.Incoming.Inventory.Trading;
using Oblivion.Communication.Packets.Incoming.LandingView;
using Oblivion.Communication.Packets.Incoming.Marketplace;
using Oblivion.Communication.Packets.Incoming.Messenger;
using Oblivion.Communication.Packets.Incoming.Misc;
using Oblivion.Communication.Packets.Incoming.Moderation;
using Oblivion.Communication.Packets.Incoming.Navigator;
using Oblivion.Communication.Packets.Incoming.Nucs;
using Oblivion.Communication.Packets.Incoming.Quests;
using Oblivion.Communication.Packets.Incoming.Rooms.Action;
using Oblivion.Communication.Packets.Incoming.Rooms.AI.Bots;
using Oblivion.Communication.Packets.Incoming.Rooms.AI.Pets;
using Oblivion.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Oblivion.Communication.Packets.Incoming.Rooms.Avatar;
using Oblivion.Communication.Packets.Incoming.Rooms.Camera;
using Oblivion.Communication.Packets.Incoming.Rooms.Chat;
using Oblivion.Communication.Packets.Incoming.Rooms.Connection;
using Oblivion.Communication.Packets.Incoming.Rooms.Engine;
using Oblivion.Communication.Packets.Incoming.Rooms.FloorPlan;
using Oblivion.Communication.Packets.Incoming.Rooms.Furni;
using Oblivion.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Oblivion.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Oblivion.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Oblivion.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Oblivion.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Oblivion.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
...
//using Oblivion.Communication.Packets.Incoming.Help.Helpers;
...
namespace Oblivion.Communication.Packets
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Oblivion.Communication.Packets");
...
/*
        ...
        public void UnregisterAll() => _incomingPackets.Clear();
        ...
        private void RegisterCatalog()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.PurchaseFromCatalogAsGiftMessageEvent,
                new PurchaseFromCatalogAsGiftEvent());
            ...
            _incomingPackets.Add(ClientPacketHeader.GetCatalogRoomPromotionMessageEvent,
                new GetCatalogRoomPromotionEvent());
        ...
        private void RegisterMarketplace()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.GetMarketplaceItemStatsMessageEvent,
                new GetMarketplaceItemStatsEvent());
        ...
        private void RegisterNavigator()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.UpdateNavigatorSettingsMessageEvent,
                new UpdateNavigatorSettingsEvent());
        ...
        {
            _incomingPackets.Add(ClientPacketHeader.RenderRoomEvent, new CustomRenderRoomEvent());
            _incomingPackets.Add(ClientPacketHeader.PurchasePhotoEvent, new PurchasePhotoEvent());
            _incomingPackets.Add(ClientPacketHeader.GetCameraPriceEvent, new GetCameraPrice());
        }

        public void RegisterPoll()
        {
            _incomingPackets.Add(ClientPacketHeader.AnswerPollQuestionMessageEvent, new AnswerPollQuestionEvent());
            _incomingPackets.Add(ClientPacketHeader.AcceptPollQuestiosMessageEvent, new AcceptPollQuestionsEvent());
            _incomingPackets.Add(ClientPacketHeader.DeclinePollQuestionsMessageEvent, new DeclinePollQuestionsEvent());
        }
        ...
        {
            _incomingPackets.Add(ClientPacketHeader.InitializeNewNavigatorMessageEvent,
                new InitializeNewNavigatorEvent());
            _incomingPackets.Add(ClientPacketHeader.NewNavigatorSearchMessageEvent, new NewNavigatorSearchEvent());
            _incomingPackets.Add(ClientPacketHeader.FindRandomFriendingRoomMessageEvent,
                new FindRandomFriendingRoomEvent());
        }
        ...
        /*      private void RegisterHelperTool()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.CloseHelperChatSessionMessageEvent,
                new CloseHelperChatSessionEvent());
            _incomingPackets.Add(ClientPacketHeader.HelperSessioChatTypingMessageEvent,
                new HelperSessioChatTypingEvent());
            _incomingPackets.Add(ClientPacketHeader.HelperSessioChatSendMessageMessageEvent,
                new HelperSessioChatSendMessageEvent());
            _incomingPackets.Add(ClientPacketHeader.InvinteHelperUserSessionMessageEvent,
                new InvinteHelperUserSessionEvent());
            _incomingPackets.Add(ClientPacketHeader.VisitHelperUserSessionMessageEvent,
                new VisitHelperUserSessionEvent());
        }*/
       ...
       //     _incomingPackets.Add(ClientPacketHeader.ChangeToSpectatorMode, new ChangeToSpectatorMode());
        }
        ...
        private void RegisterUsers()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.SetMessengerInviteStatusMessageEvent,
                new SetMessengerInviteStatusEvent());
        ...
        private void RegisterSound()
        {
            ...
            // _incomingPackets.Add(3095, new GetNowPlayingEvent());
            ...
            _incomingPackets.Add(ClientPacketHeader.RemoveDiscFromPlayListMessageEvent,
                new RemoveDiscFromPlayListEvent());
        }
        ...
        private void RegisterGroups()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.UpdateForumThreadStatusMessageEvent,
                new UpdateForumThreadStatusEvent());
            ...
            _incomingPackets.Add(ClientPacketHeader.GetGroupCreationWindowMessageEvent,
                new GetGroupCreationWindowEvent());
            ...
            _incomingPackets.Add(ClientPacketHeader.DeclineGroupMembershipMessageEvent,
                new DeclineGroupMembershipEvent());
        ...
        private void RegisterFurni()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.YouTubeVideoInformationMessageEvent,
                new YouTubeVideoInformationEvent());
        ...
        private void RegisterModeration()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.GetModeratorRoomChatlogMessageEvent,
                new GetModeratorRoomChatlogEvent());
            _incomingPackets.Add(ClientPacketHeader.GetModeratorUserChatlogMessageEvent,
                new GetModeratorUserChatlogEvent());
        ...
        public void RegisterGameCenter()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.Game2GetWeeklyLeaderboardMessageEvent,
                new Game2GetWeeklyLeaderboardEvent());
        }
        ...
        public void RegisterNames()
        {
            ...
            _packetNames.Add(ClientPacketHeader.OpenCalendarBoxMessageEvent, "CampaignCalendarGiftEvent");
            ...
            _packetNames.Add(ClientPacketHeader.GetGiftWrappingConfigurationMessageEvent,
                "GetGiftWrappingConfigurationEvent");
            _packetNames.Add(ClientPacketHeader.GetMarketplaceConfigurationMessageEvent,
            ...
            _packetNames.Add(ClientPacketHeader.GetMarketplaceCanMakeOfferMessageEvent,
            ...
            _packetNames.Add(ClientPacketHeader.GetJukeboxDiscsDataMessageEvent, "GetSongInfoEvent");
            ...
            _packetNames.Add(ClientPacketHeader.SaveEnforcedCategorySettingsMessageEvent,
                "SaveEnforcedCategorySettingsEvent");
            ...
            _packetNames.Add(ClientPacketHeader.InitializeFloorPlanSessionMessageEvent,
                "InitializeFloorPlanSessionEvent");
            _packetNames.Add(ClientPacketHeader.FloorPlanEditorRoomPropertiesMessageEvent,
                "FloorPlanEditorRoomPropertiesEvent");
            ...
            _packetNames.Add(ClientPacketHeader.GetModeratorUserRoomVisitsMessageEvent,
                "GetModeratorUserRoomVisitsEvent");
            ...
            _packetNames.Add(ClientPacketHeader.GetModeratorTicketChatlogsMessageEvent,
                "GetModeratorTicketChatlogsEvent");
