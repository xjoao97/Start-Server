namespace Oblivion.Communication.Packets.Outgoing
{
    ...
    {
        public const int InitHelperSessionChatMessageComposer = 2926;
        public const int HelperSessionVisiteRoomMessageComposer = 579;
        public const int HelperSessionSendChatMessageComposer = 379;
        public const int HelperSessionInvinteRoomMessageComposer = 1554;
        public const int HelperSessionChatIsTypingMessageComposer = 495;
        public const int HandleHelperToolMessageComposer = 939;
        public const int EndHelperSessionMessageComposer = 118;
        public const int CloseHelperSessionMessageComposer = 3258;
        public const int CallForHelperWindowMessageComposer = 1468;
        public const int CallForHelperErrorMessageComposer = 819;
        public const int UpdateHallOfFameCodeDataMessageComposer = 2052;
        public const int UpdateHallOfFameListMessageComposer = 217;
        public const int AvatarEffectActivatedMessageComposer = 295;

        public const int LoadJukeboxUserMusicItemsMessageComposer = 11;
        public const int SetJukeboxNowPlayingMessageComposer = 3089;
        public const int SetJukeboxSongMusicDataMessageComposer = 2925;
        public const int SetJukeboxPlayListMessageComposer = 932;
        ...
        public const int ForumDataMessageComposer = 3684;
        public const int UnreadForumThreadPostsMessageComposer = 2476;

        public const int TargetOfferMessageComposer = 975;

        public const int PollQuestionsMessageComposer = 2326;
        public const int PollErrorAlertMessageComposer = 1879;
        public const int SendPollInvinteMessageComposer = 348;

        public const int MatchingPollFinishMessageComposer = 3100;
        public const int MatchingPollMessageComposer = 3252;
        public const int MatchingPollResultsMessageComposer = 2053;
        ...
        public const int NuxNotificationMessageComposer = 3337;
        ...
        public const int ModeratorSupportTicketResponseMessageComposer = 3713;
        ...
        public const int ModeratorTicketChatlogMessageComposer = 2836;
        ...
        public const int SuperNotificationMessageComposer = 619; //Gabo
        ...
        public const int NuxAlertMessageComposer = 764; // PRODUCTION-201607262204-86871104
        public const int NuxUserStatus = 2344; // PRODUCTION-201607262204-86871104

        public const int FurniMaticNoRoomError = 3719; // b
        public const int FurniMaticReceiveItem = 3878; // b
        public const int FurniMaticRewardsComposer = 2704; // b
    }
}