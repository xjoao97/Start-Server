...
namespace Oblivion.Communication.Packets.Outgoing.Groups
{
    ...
    {
        public ForumsListDataComposer(ICollection<GroupForum> Forums, GameClient Session, int ViewOrder = 0,
            int StartIndex = 0)
            : base(ServerPacketHeader.ForumsListDataMessageComposer)
        {
            ...
            foreach (var Forum in Forums)
            {
                ...
                WriteInteger(isn ? (int) OblivionServer.GetUnixTimestamp() - lastpost.Timestamp : 0);
