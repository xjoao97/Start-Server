...
namespace ConsoleWriter
{
    public class Writer
    {
        ...
        public static void LogException(string logText) => WriteToFile(@"Logs\exceptions.txt", logText + "\r\n\r\n");

        public static void LogCriticalException(string logText)
            => WriteToFile(@"Logs\criticalexceptions.txt", logText + "\r\n\r\n");

        public static void LogMySQLError(string logText) => WriteToFile(@"Logs\mysql_error.txt", logText + "\r\n\r\n");
        ...
        public static void HandleException(Exception pException, string pLocation)
        {
            ...
            ExceptionData.AppendLine("Exception logged " + DateTime.Now + " in " + pLocation + ":");
        ...
        private static void WriteToFile(string path, string content)
        {
            try
            {
                ...
                var Msg = Encoding.ASCII.GetBytes(Environment.NewLine + content);
