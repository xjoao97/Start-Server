...
//        private SocketManager manager;
        ...
        public ConnectionInformation(int connectionID, Socket dataStream, SocketManager manager, IDataParser parser,
            string ip)
        {
            this.parser = parser;
...
//                disconnect();
        ...
        private void handlePacketData(byte[] packet) => parser?.handlePacketData(packet);
        ...
        public void SendData(byte[] packet)
        {
            try
            {
                ...
                // var packetData = Encoding.Default.GetString(packet);
