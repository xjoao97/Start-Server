...
namespace Oblivion.Core
{
    public static class Logging
    {
        ...
        public static void LogWiredException(string logText) => Writer.LogWiredException(logText);

        public static void LogCacheException(string logText) => Writer.LogCacheException(logText);

        public static void LogPathfinderException(string logText) => Writer.LogPathfinderException(logText);

        public static void LogCriticalException(string logText) => Writer.LogCriticalException(logText);
